...
export class SetupTables1727084994199 implements MigrationInterface {
    name = 'SetupTables1727084994199'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        `);
        await queryRunner.query(`
            CREATE TYPE "public"."newsletter_status_enum" AS ENUM('SENT', 'CANCELED')
        `);
        await queryRunner.query(`
            CREATE TABLE "newsletter" (
                "id" SERIAL NOT NULL,
                "message" text NOT NULL,
                "status" "public"."newsletter_status_enum" NOT NULL,
                "sentAt" TIMESTAMP,
                "userId" integer,
